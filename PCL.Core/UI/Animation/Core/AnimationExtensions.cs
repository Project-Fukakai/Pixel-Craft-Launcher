...
public static class AnimationExtensions
{
    ...
    public static readonly DependencyProperty TargetProperty =
        AvaloniaProperty.RegisterAttached<AttachedOwner, DependencyObject?>("Target", typeof(DependencyObject));
    ...
    public static readonly DependencyProperty TargetPropertyProperty =
        AvaloniaProperty.RegisterAttached<AttachedOwner, DependencyProperty?>("TargetProperty", typeof(DependencyObject));
