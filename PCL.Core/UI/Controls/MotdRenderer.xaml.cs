...
public partial class MotdRenderer : UserControl {
    ...
    private static readonly Dictionary<string, IBrush> ColorMapWithBlackBackground = new() {
    ...
    private static readonly Dictionary<string, IBrush> ColorMapWithWhiteBackground = new() {
    ...
    private readonly Canvas MotdCanvas = new()
    {
    ...
    private TextBlock _RenderText(string text, FontFamily fontFamily, double fontSize, IBrush color,
        ...
        if (isUnderline || isStrikethrough) {
            textBlock.TextDecorations = isStrikethrough ? TextDecorations.Strikethrough : TextDecorations.Underline;
        }
    ...
    private static double _MeasureTextWidth(string text, FontFamily fontFamily, double fontSize, bool isBold, bool isItalic) {
        var weightFactor = isBold ? 0.68 : 0.6;
