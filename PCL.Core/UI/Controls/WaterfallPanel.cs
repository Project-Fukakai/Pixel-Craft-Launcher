...
public class WaterfallPanel : Panel
{
    ...
    public static readonly DependencyProperty LayoutModeProperty =
        AvaloniaProperty.Register<WaterfallPanel, WaterfallLayoutMode>(
            nameof(LayoutMode), WaterfallLayoutMode.FixedColumns);
    ...
    public static readonly DependencyProperty ColumnCountProperty =
        AvaloniaProperty.Register<WaterfallPanel, int>(nameof(ColumnCount), 2);
    ...
    public static readonly DependencyProperty ColumnSpacingProperty =
        AvaloniaProperty.Register<WaterfallPanel, double>(nameof(ColumnSpacing), 5.0);
    ...
    public static readonly DependencyProperty RowSpacingProperty =
        AvaloniaProperty.Register<WaterfallPanel, double>(nameof(RowSpacing), 0.0);
    ...
    public static readonly DependencyProperty MaxItemWidthProperty =
        AvaloniaProperty.Register<WaterfallPanel, double>(nameof(MaxItemWidth), 100.0);
