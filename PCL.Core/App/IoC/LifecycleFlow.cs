...
partial class Lifecycle
{
    ...
    public static void OnInitialize()
    {
        ...
        // Avalonia 的应用生命周期由宿主程序启动，这里只推进 Core 生命周期。
        if (CurrentApplication.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime)
            OnLoading();
    }
    ...
    public static void OnLoading()
    {
        ...
        // 运行窗体
        if (CurrentApplication.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime { MainWindow: { } window })
            window.Show();
    }
