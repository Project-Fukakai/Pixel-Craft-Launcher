...
public static class Basics
{
    ...
    public static Stream? GetResourceStream(string path)
    {
        try
        {
            return AssetLoader.Open(new Uri($"avares://PCL.Core/{path.TrimStart('/')}"));
        }
        catch
        {
            return null;
    ...
    private const string AssemblyImagePath = "pack://application:,,,/Pixel Craft Launcher;component/Images/";
